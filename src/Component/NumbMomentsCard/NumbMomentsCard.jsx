...
export default function NumbMomentsCard ({username, days, session, emotion1, sns1, sns2, averagewatchingtime}){
    return (
        
        <div className = 'numb-moments'>
            <div className='numb-moments-title'>
                <h1>무심코 스크롤한 순간을 돌아봤어요</h1>
                <span><ViewMoreIcon/></span>
            </div>
            
            <div className='numb-moments-contents'>
